...
|[**100-intel**](https://github.com/GM-Samuelstein/alx-low_level_programming/blob/master/0x00-hello_world/100-intel)|*This Shell Script generates the assembly code (Intel syntax) of a C file that is saved in the variable named `$CFILE`. *|
