...
|---|---|
|[**libmy.a**](https://github.com/GM-Samuelstein/alx-low_level_programming/blob/master/0x09-static_libraries/libmy.a)|*A static library that contains a list of functions.*|
